package com.dev.servlet.core.decorator;
...
/**
 * Decorator that adds caching capabilities to any service that implements {@link ICrudRepository}.
...
public class CachedServiceDecorator<T extends Identifier<K>, K> implements ICrudRepository<T, K> {
    ...
    /**
     * Creates a new {@link CachedServiceDecorator} with a specific cache token.
     *
     * @param decorated      The service to decorate with caching
    ...
    /**
     * Builds a cache key for a pageable request.
     *
