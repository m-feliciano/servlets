# Diagramas de Relacionamento entre Classes

## 1. Diagrama de Entidades de Domínio
...
## 2. Diagrama de Arquitetura por Camadas
...
## 3. Diagrama do Sistema de Cache (Decorator Pattern)
...
## 4. Diagrama de Fluxo de Request
...
## 5. Diagrama de Sistema de Segurança
...
## 6. Diagrama de Web Scraping Architecture
...
## 8. Diagrama de Validação e Anotações
...
## 10. Diagrama de Configuração e Injeção de Dependência
...
Estes diagramas mostram as principais relações e fluxos entre as classes do sistema, demonstrando como a arquitetura limpa e os padrões de design trabalham juntos para criar uma aplicação robusta e bem estruturada.