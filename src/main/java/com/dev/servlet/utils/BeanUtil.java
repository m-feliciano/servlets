...
public final class BeanUtil {
    ...
    public static class DependencyResolver {
        ...
        public static final String BUSINESS_PACKAGE = "com.dev.servlet.business";
        ...
        /**
         * Resolves all services annotated with {@link ResourcePath}.
         */
        @SuppressWarnings("unchecked")
        public synchronized void resolveAll() {
            try {
                List<Class<?>> clazzList = ClassUtil.loadClasses(BUSINESS_PACKAGE, new Class[]{ResourcePath.class});
                for (Class<?> clazz : clazzList) {
                    String path = clazz.getAnnotation(ResourcePath.class).value();
