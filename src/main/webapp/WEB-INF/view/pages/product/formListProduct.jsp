...
<%
    request.setAttribute("product", ((IHttpResponse<?>) request.getAttribute("response")).getResponse());
%>
        ...
        <div class="col-md-6">
            ...
            <div class="row justify-content-end mr-0 mb20">
                <jsp:include page="/WEB-INF/view/components/buttons/customButton.jsp">
                    ...
                    <jsp:param name="btnOnclick" value="onclick='window.location.href=`${ listProduct }`'"/>
