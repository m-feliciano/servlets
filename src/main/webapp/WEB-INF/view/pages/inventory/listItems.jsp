...
<%
    ...
    request.setAttribute("items", servletResponse.getResponse("items"));
%>
...
<div class="main">
    <jsp:include page="/WEB-INF/view/components/search.jsp">
        ...
        <jsp:param name="action" value="${ listInventory }"/>
        <jsp:param name="onclear" value="${ listInventory }"/>
    </jsp:include>
                        ...
                        <tr>
                            ...
                            <td class="w-20">
                                <a style="text-decoration: none; color: inherit;  padding: 2rem 0;"
                                   href="${ listProduct }?id=${ inventory.getProduct().getId() }"
                            ...
                            <td class="w-10">
                                ...
                                <form action="${ deleteItem }/${ inventory.id }" method="post" class="d-inline">
